#ifndef GATEWAY_RTMP_RTMP_GATEWAY_HPP
#define GATEWAY_RTMP_RTMP_GATEWAY_HPP
 ...
 * @brief RTMP Gateway
 * 
 * RTMP 是原生协议，直接使用 ZLMediaKit API 管理流
 * 不使用 FFmpeg，性能最大化
 */
class RTMPGateway : public GatewayBase {
public:
    /**
     * @brief 构造函数
     * @param config 配置对象
     ...
     */
    RTMPGateway(std::shared_ptr<config::Config> config,
    ...
    std::string GetProtocol() const override { return "rtmp"; }
...
#endif // GATEWAY_RTMP_RTMP_GATEWAY_HPP
